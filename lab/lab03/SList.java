...
public class SList {
  ...
  public static void main (String[] args) {
    // Fill in your solution for Part I here.
      SList lstPart1 = new SList();
      lstPart1.insertFront(12);
      lstPart1.insertFront(9);
      lstPart1.insertFront(6);
      System.out.println("Here is the first list for Part I: " +
			 lstPart1.toString());
      TestHelper.verify(lstPart1.toString().equals("[  6  9  12  ]"),
			"toString on newly constructed list failed");

      lstPart1.insertFront(3);
      lstPart1.insertEnd(15);
      System.out.println("Here is the second list for Part I: " +
			 lstPart1.toString());
      TestHelper.verify(lstPart1.toString().equals("[  3  6  9  12  15  ]"),
			"toString on newly constructed list failed");
